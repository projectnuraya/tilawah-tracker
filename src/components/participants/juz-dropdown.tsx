	...
	return (
		<div className='relative' onClick={(e) => e.preventDefault()}>
			<select
				...
				disabled={isUpdating}
				className='min-h-12 appearance-none bg-transparent border border-border rounded-lg px-3 pr-9 text-base font-medium text-foreground hover:bg-muted/50 focus:outline-none focus:ring-2 focus:ring-ring focus:border-transparent disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer'
